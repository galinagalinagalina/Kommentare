...
% Zeile 6
derwesten.de &
   {\bf keine}: automatische Veröffentlichung; Entfernen (zeitweise/ganz) durch
...
% Zeile 9
rp-online.de &
   {\bf keine}: bei Melden Entfernen/Sperren (auch die Antworten dazu); Abbruch der
...
% Zeile 10
handelsblatt.de &
   {\bf eingeschränkte Post-Moderation}: keine umfassende Prüfung, aber Eingriff bei
...
% Zeile 11
suedkurier.de &
   {\bf eingeschränkte Post-Moderation}: keine umfassende Prüfung;  Bearbeiten/Löschen
...
% Zeile 12
zeit.de &
   {\bf Prä-Moderation} (wie bei Leserbriefen): Entfernen/Kürzen (mit Begründung),
...
% Zeile 13
badische-zeitung.de &
   {\bf eingeschränkte Post-Moderation}: keine umfassende Prüfung;
