...
\begin{landscape}\footnotesize
  ...
  \caption{Kategorie \glqq Registrierung\grqq}%\footnote{Die Angabe einer Emailadresse und eines Passworts wird immer verlangt. In der Tabelle sind weitere obligatorische Angaben, Unterkategorien, aufgeführt.}
  \\
