...
focus.de & \emph{AGB (Zustimmung), Netiquette (Zustimmung)}
	...
	Nutzer selbst;\tabularnewline\midrule
...
rp-online.de & \emph{AGB}
	...
	unwahren, unsachlichen Beiträge; keine Schadsoftware\tabularnewline\midrule
...
zeit.de & \emph{AGB (Zustimmung), Netiquette (besonders ausführlich und erklärend)}
	...
	Daten frei zugänglich werden; keine Schadsoftware\tabularnewline\midrule
...
stuttgarter-zeitung.de & \emph{AGB (Zustimmung), Kommentarregeln = Netiquette}
	...
	Vervielfältigung)\tabularnewline\midrule
...
merkur.de & \emph{AGB (Zustimmung), Netiquette (Zustimmung)}
	...
	Zwecke; keine Junkmails/Spam/Kettenbriefe\tabularnewline\midrule
