...
handelsblatt.com & \emph{Nutzungshinweise (Zustimmung), Netiquette}
	...
	keine: Diskriminierungen jeder Art;  Beschimpfungen, Beiträge mit strafrechtlich relevanten Inhalten; 
	Angaben über Dritte; %sich bewusst machen,
	%welche eigenen Daten frei zugänglich ins Internet gestellt werden (steht jetzt bei Allgemeines);
	Trolle; Schadsoftware; Nennung von Produktnamen, Dienstleistern, Marken, Produzenten

	auf Nutzungsrechte von handelsblatt.de wird nicht hingewiesen\tabularnewline\midrule
...
suedkurier.de & \emph{Nutzungsbedingungen (Zustimmung), Netiquette}
	...
	keine: nicht-belegbaren Be\-haup\-tun\-gen, Beschimpfungen, Dif\-fam\-ier\-un\-gen, Dro\-hun\-gen, Dis\-kri\-mi\-nie\-run\-gen
	aller Art, Hetze, Ge\-walt\-ver\-herr\-li\-chung, Vul\-gär\-aus\-drücke;  Angaben über Dritte
	\tabularnewline\midrule
...
zeit.de & \emph{AGB (Zustimmung), Netiquette (besonders ausführlich und erklärend)}
	...
	keine: Beschimpfungen, Diskriminierungen aller Art (auch Behinderung, Einkommensverhältnisse), Diffamierungen; Verdächtigungen; 
	Angaben über Dritte; 
	Schadsoftware\tabularnewline\midrule
...
badische zeitung.de & \emph{AGB (Zustimmung), Netiquette}
	...
	keine: Beiträge mit hetzerischem, gewaltverherrlichendem Inhalt; privaten Daten\tabularnewline\midrule
...
stuttgarter-zeitung.de & \emph{AGB (Zustimmung), Kommentarregeln = Netiquette}
	...
	keine: Beschimpfungen, Schmä\-hun\-gen, Volks\-ver\-het\-zung, Pro\-pa\-gan\-da,
	Beiträge mit
	...
	Schadsoftware; 
	privaten Daten; 
	Angaben über Dritte \tabularnewline\midrule
